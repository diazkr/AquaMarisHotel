...
import SimpleCarousel from "@/componentes/lista/CarouselComponent";

interface CardPaymentRoomProps {
  id: string;
  type: string;
  images: string[];
  services: string[];
...
const CardPaymentRoom: React.FC<CardPaymentRoomProps> = ({
    id,
  type,
  images,
  services,
  ...
  return (
    <div className="my-2 border border-gray-300 w-[100%] bg-slate-50">
      ...
      <div className="flex justify-between items-center bg-slate-200 p-1 rounded-b-sm "></div>
      <Popover
        open={open}
        anchorEl={anchorEl}
...
export default CardPaymentRoom;
